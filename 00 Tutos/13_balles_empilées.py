...
class CercleSurArc(Scene):
    def construct(self):
        ...
        self.all_objs.add(brace1, brace2)
        ...
        self.wait()
        self.play(MoveAlongPath(cercle1, arc_path_back),
                  FadeOut(brace0),
                  FadeOut(brace1),
                  FadeOut(brace2),
                  #FadeOut(brace3)
        ...
        # ---- REPERES DYNAMIQUES ----
        horizontalDashedLine_cercle0 = always_redraw(lambda: DashedLine(
            cercle0.get_center() - RIGHT * 2,
            cercle0.get_center() + RIGHT * 4,
            color=GREY
        ))
        horizontalDashedLine_cercle1 = always_redraw(lambda: DashedLine(
        ...
        def double_fleche_redraw ():
            start_point = [x_pos + delta, horizontalDashedLine_cercle0.get_y(), 0]
            end_point   = [x_pos + delta, horizontalDashedLine_cercle1.get_y(), 0]
        ...
        #-----------------------
        self.play(Create(horizontalDashedLine_cercle0), Create(horizontalDashedLine_cercle1), GrowArrow(double_fleche))
        ...
        self.all_objs.add(horizontalDashedLine_cercle0, horizontalDashedLine_cercle1, double_fleche, label_x)
        self.wait(4)

        # On met tout en gris pour préparer la solution
        standard_color = GREY
        self.all_objs_solution = VGroup().add(cercle0,cercle1,cercle2,cercle3,centre0,centre1,centre2,centre3,horizontalDashedLine_cercle0,horizontalDashedLine_cercle1)
